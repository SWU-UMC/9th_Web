...
interface CustomlnternalAxiosRequestConfig extends InternalAxiosRequestConfig {
...
axiosInstance.interceptors.response.use(
    ...
    async (error) => {
        const originalRequest: CustomlnternalAxiosRequestConfig = error.config;
